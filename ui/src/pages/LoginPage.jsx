...
export function LoginPage({ onAuthenticated, onBack }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        {onBack && (
          <button onClick={onBack} className="text-arena-muted hover:text-arena-gold transition-colors flex items-center gap-1 text-sm mb-4">
